%% ========================================================================
% MASTER INITIALIZATION SCRIPT: M01 Pure Pursuit Baseline
% Architecture: Pure Kinematic Path Tracking (No Dynamic Saturation Control)
% Purpose: Establishes the baseline failure mode (spin-out) at high lateral 
% accelerations to prove the necessity of active stability intervention.
% =========================================================================
clear; clc;

%% 1. HIGH-FIDELITY PLANT: VEHICLE GEOMETRY & MASS
% Defining the 3DOF Single Track (Bicycle) dynamic parameters.
% Note: Geometric planners (like Pure Pursuit) ignore these physical constraints, 
% which is exactly why they fail when lateral forces saturate the tires.
...
X_scaled = raw_track(:, 1) * 0.1;
Y_scaled = raw_track(:, 2) * 0.1;
...
k_pp = 0.45; % Locked in as the optimal stable gain for L_d calculation
% =========================================================================
